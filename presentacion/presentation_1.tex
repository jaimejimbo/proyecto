...
\author{Jaime P\'erez Aparicio} % Your name
\institute[UAM] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Universidad Aut\'onoma de Madrid \\ % Your institution for the title page
\medskip
%\textit{jaime.pereza@estudiante.uam.es} % Your email address
}
